...
<html lang="en">
      ...
      <div class="col-sm-8">
         <div class="card">
            <div class="card-body">
               ...
               <form class="form-horizontal" role="form" action="buildyourown_step1.php" method="POST">
                  <div class="row">
  ...
  if(isset($_SESSION['first_name'])){
      ...
      <div class="row">
      	<a class="btn btn-primary" href="buildyourown_step1.php?address=own" style="display:block;margin: 0px auto" role="button">Select my Home Address&nbsp;<i class="fa fa-arrow-circle-right"></i></a>
      </div>';
  }
    echo '</div></div>';
    ...
    <hr class="hrule" />
      ...
      <div class="col-sm-2"></div>
  <div class="col-sm-4">
    <a href="buildyourown_step1.php?location=campus">
  ...
  <div class="col-sm-4">
  	<a href="buildyourown_step1.php?location=west">
    <div class="card card-hover">
      <div class="card-body">
